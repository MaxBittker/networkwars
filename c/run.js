...
const bin = process.env.NW_BIN ? (process.env.NW_BIN[0] === '/' ? process.env.NW_BIN : __dirname + '/' + process.env.NW_BIN) : __dirname + '/nw';
const res = execFileSync(bin, extra, { input, maxBuffer: 1 << 28, stdio: ['pipe', 'pipe', 'inherit'] }).toString().trim();
