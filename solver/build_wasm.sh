...
emcc -O3 solver/fast_engine.c -o public/fast_engine.js \
  ...
  -sEXPORTED_FUNCTIONS=_malloc,_free,_new_game,_new_game_legacy,_ext_attack_legal,_set_topology,_get_adj,_get_links,_set_rng_mb32,_get_rng_mb32,_set_sim_seed,_use_mb32_rng,_use_sim_rng,_uct_search,_uct_begin,_uct_step,_uct_report,_uct_sims_done,_uct_set_value_stop,_uct_set_grade,_resolve_battle_logged,_ext_reinforce,_bot_turn_begin,_bot_turn_next,_ext_check_winner,_ext_resolve_battle,_end_turn,_rollout,_sweep_best_move,_sweep_certify
